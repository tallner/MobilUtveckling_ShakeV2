...
public class Fragment2 extends Fragment  implements SensorEventListener {
    ...
    public void onStart() {
        ...
        View view = getView();
        if (view != null){
            xValue = (TextView) view.findViewById(R.id.xSignedNumber);
            yValue = (TextView) view.findViewById(R.id.ySignedNumber);
            zValue = (TextView) view.findViewById(R.id.zSignedNumber);
        }
    }
